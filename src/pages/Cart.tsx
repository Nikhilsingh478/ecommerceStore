      ...
      {items.length === 0 ? (
        ...
        <>
          <div className="flex flex-col gap-2 p-2">
            {items.map((item) => (
              <div key={item.product.id} className="flex gap-3 rounded-lg bg-card p-3">
          ...
          <div className="fixed bottom-14 left-0 right-0 z-40 flex items-center justify-between border-t border-border bg-card px-4 py-3 shadow-lg">
            <div>
